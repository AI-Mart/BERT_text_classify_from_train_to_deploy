...
def get_masked_lm_output(bert_config, input_tensor, output_weights, positions,
  ...
  with tf.variable_scope("cls/predictions"):
    # We apply one more non-linear transformation before the output_predict layer.
    ...
    # The output_predict weights are the same as the input embeddings, but there is
    # an output_predict-only bias for each token.
