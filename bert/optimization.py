...
def find_train_variables(tvars):
    ...
    """
    # bert/encoder/layer_21, bert/encoder/layer_9, bert/encoder/layer_20/attention/output_predict/dense/bias:0, bert/encoder/layer_20/attention/output_predict/dense/kernel:
    tvars_result_list=[]
